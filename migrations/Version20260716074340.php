 ...
 */
final class Version20260716074340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER email_auth_code TYPE VARCHAR(6)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER email_auth_code TYPE VARCHAR(10)');
    }
}
